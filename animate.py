...
class artist:
    ...
    def doit(self,params):
        ...
        cv2.imwrite(self.outputDir+"frame_%06d.png"%frame,img)
        frame+=1
        ...
        if not blurSize is None:
            for b in range(1,blurSize+1):
              cv2.imwrite(self.outputDir+"frame_%06d.png"%frame,cv2.blur(img,(b,b)))
              frame+=1
...
#pfd=open("foundparamsv16_first.txt",'w')
#print >>pfd,params
#print >>pfd,bounds
#pfd.close()
#
...
#        x=params[:]
#        x,b=searchForParameters("outputv16_%d_%d"%(tries,f),orig,params,bounds,25)
#        baseparams=x[:8]
...
#                
#        
#    pfd=open("foundparamsv16_%d.txt"%f,'w')
#    print >>pfd,params
#    print >>pfd,bounds
#    pfd.close()
#    params=localopt(optimizeme,params,bounds,[True,]*len(bounds),1)
#    pfd=open("foundparamsv16final_%d.txt"%f,'w')
#    print >>pfd,params
#    print >>pfd,bounds
#    pfd.close()
#    s=score(z,orig)
...
#    if len(zprg) <= 1024:
#        fd=open("draw_finalv16_%d.py"%f,'w')
#        print >>fd,prg,
#        fd.close()
#        fd=open("cdraw_finalv16_%d.py"%f,'w')
#        print >>fd,zprg,
#        fd.close()
